...
export const VIEW_CONTAINER = shouldRegisterExtensionsViewContainer ? Registry.as<IViewContainersRegistry>(ViewContainerExtensions.ViewContainersRegistry).registerViewContainer(
	{
		id: VIEWLET_ID,
	...
	}, ViewContainerLocation.Sidebar) : undefined;
